...
def main():
    ...
    images_folder = script_dir + '/images/imagenet2000/'
    ...
    for model_obj in all_models:
        ...
        if "object detection segmentation" not in tags or model_opset < 7 or "preproc" in model_name or "_DUC_" in model_name:
